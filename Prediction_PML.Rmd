...
## Import data
```{r,warning=FALSE}
training_set <- read.csv("C:/Users/chaoh/Desktop/TEMP/PML/Prediction_PML/pml-training.csv")
testing_set <-read.csv("C:/Users/chaoh/Desktop/TEMP/PML/Prediction_PML/pml-testing.csv")
```
